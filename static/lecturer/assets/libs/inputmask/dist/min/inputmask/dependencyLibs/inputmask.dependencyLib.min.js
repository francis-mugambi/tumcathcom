  ...
  return (
    (l.prototype = {
      on: function (e, t) {
        if (a(this[0]))
          for (
            var n = this[0].eventRegistry, i = this[0], o = e.split(" "), r = 0;
            r < o.length;
            r++
          ) {
            var l = o[r].split(".");
                  ...
                  if (e.length > 0)
                    ...
                    for (var l in n)
                      for (var s in n[l])
                        if (s === i)
                          if (void 0 === t)
                            for (o = 0, r = n[l][s].length; o < r; o++)
                              a.push({
                                ev: l,
                                namespace: s,
                                handler: n[l][s][o],
                              });
                          else a.push({ ev: l, namespace: s, handler: t });
                  return a;
                })(l[0], l[1]),
                f = 0,
                c = s.length;
    ...
    (l.isPlainObject = function (e) {
      return (
        ...
        !(
          e.constructor &&
          !s.hasOwnProperty.call(e.constructor.prototype, "isPrototypeOf")
        )
      );
    }),
    (l.extend = function () {
            ...
            (n = a[t]),
              a !== (i = e[t]) &&
                (c && i && (l.isPlainObject(i) || (o = l.isArray(i)))
                  ? (o
                      ? ((o = !1), (r = n && l.isArray(n) ? n : []))
                      : (r = n && l.isPlainObject(n) ? n : {}),
                    (a[t] = l.extend(c, r, i)))
                  : void 0 !== i && (a[t] = i));
      return a;
    }),
